...
if ( isset($_GET['fave_agent_service_area']) && $_GET['fave_agent_service_area'] != '' ) {
    $meta_query[] = array(
        'key'     => 'fave_agent_service_area',
        'value'   => sanitize_text_field($_GET['fave_agent_service_area']),
        'compare' => 'LIKE'
    );
}

if ( isset($_GET['fave_agent_specialties']) && $_GET['fave_agent_specialties'] != '' ) {
    $meta_query[] = array(
        'key'     => 'fave_agent_specialties',
        'value'   => sanitize_text_field($_GET['fave_agent_specialties']),
        'compare' => 'LIKE'
    );
}
