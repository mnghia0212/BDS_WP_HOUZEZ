...
<div class="mobile-property-contact visible-on-mobile">
	<div class="d-flex justify-content-between">
		...
		<!-- ZALO -->
		<?php if( ! empty($agent_mobile_call) && houzez_option('agent_mobile_num', 1) ) { ?>
			<a target="_blank" href="https://zalo.me/<?php echo esc_attr($agent_mobile_call); ?>" class="btn btn-secondary-outlined" >
				<i class="houzez-icon icon-messaging-whatsapp mr-1"></i> <?php esc_html_e('Zalo', 'houzez'); ?>
			</a>

			<a class="btn btn-secondary-outlined" href="tel:<?php echo esc_attr($agent_mobile_call); ?>">
