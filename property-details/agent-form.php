		...
		<div class="property-form clearfix">
			<form method="post" action="#">
				...
				<?php if ( $return_array['is_single_agent'] == true && !empty($agent_number) && $agent_mobile_num && !wp_is_mobile() ) : ?>
					...
					<a target="_blank" href="https://zalo.me/<?php echo esc_attr($agent_mobile_call); ?>" data-property-id="<?php echo intval($post->ID); ?>" data-agent-id="<?php echo intval($return_array['agent_id'])?>" class="btn btn-secondary-outlined <?php echo esc_attr($whatsappBtnClass); ?>">
