...
<div class="form-group">
	...
	<input class="form-control" name="prop_price" <?php houzez_required_field_2('sale_rent_price'); ?> id="prop_price" 
...
<!-- add 5/8 -->
<script>
	document.getElementById('prop_price').addEventListener('input', function (e) {
