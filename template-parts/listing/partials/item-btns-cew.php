...
if ($buttonsComposer) {
	...
	foreach ($buttonsComposer as $key=>$value) {
		...
		// 	<?php
		// ZALO
		} elseif ($key == 'whatsapp' && $agent_mobile != '' ) { $i ++;
			?>
			<a class="btn btn-primary-outlined btn-item" target="_blank" href="https://zalo.me/<?php echo esc_attr( $agent_mobile ); ?>">
				<i class="houzez-icon icon-messaging-whatsapp"></i> <span><?php esc_html_e('Zalo', 'houzez'); ?></span>
			</a><!-- btn-item -->
			<?php
