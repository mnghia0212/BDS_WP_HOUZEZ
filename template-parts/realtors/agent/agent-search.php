		...
		<div class="advanced-search-v1">
			<form method="get" action="<?php echo esc_url($purl); ?>">
				...
				<div class="d-flex">
					...
					<div class="flex-search">
						<div class="form-group">
							<select name="category" class="selectpicker form-control bs-select-hidden" title="<?php echo $houzez_local['all_agent_cats']; ?>" data-live-search="true" data-selected-text-format="count" data-actions-box="true" data-select-all-text="<?php echo houzez_option('cl_select_all', 'Select All'); ?>" data-deselect-all-text="<?php echo houzez_option('cl_deselect_all', 'Deselect All'); ?>" data-count-selected-text="{0} <?php echo houzez_option('cl_items_selected', 'items selected'); ?>" data-none-results-text="<?php echo houzez_option('cl_no_results_matched', 'No results matched');?> {0}">
								<?php houzez_get_search_taxonomies('agent_category', $category ); ?>
							</select><!-- selectpicker -->
						</div><!-- form-group -->
					</div><!-- flex-search -->
					...
					<div class="flex-search">
						<div class="form-group">
							<div class="search-icon">
								<input type="text" name="fave_agent_service_area" class="form-control" placeholder="<?php echo $houzez_local['search_fave_agent_service_area']?>" value="<?php echo esc_html($fave_agent_service_area); ?>">
							</div><!-- search-icon -->
						</div><!-- form-group -->
					</div><!-- flex-search -->
					...
					<div class="flex-search">
						<div class="form-group">
							<div class="search-icon">
								<input type="text" name="fave_agent_specialties" class="form-control" placeholder="<?php echo $houzez_local['search_fave_agent_specialties']?>" value="<?php echo esc_html($fave_agent_specialties); ?>">
							</div><!-- search-icon -->
						</div><!-- form-group -->
					</div>flex-search
